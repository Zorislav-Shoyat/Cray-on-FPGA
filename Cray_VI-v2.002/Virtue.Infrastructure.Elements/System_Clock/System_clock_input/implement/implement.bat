...
xst -ifn xst.scr
move System_clock_input_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\System_clock_input_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc System_clock_input_exdes.ucf System_clock_input_exdes

echo 'Running map'
map -timing -pr b System_clock_input_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm System_clock_input_exdes -w routed.ncd routed.v
cd ..
