...
// Debugged by Zorislav Shoyat, 18/3/2015, 19:45
...
module float_add(clk, rst, i_cip, i_vstart,i_vector_length, i_sj, i_sk,i_v0,i_v1,i_v2,i_v3,i_v4,i_v5,i_v6,i_v7, o_busy, o_result, err);
    ...
    reg add2;                   //determine if you should add or subtract
...
// ZS:
// For now generate error:
assign err = exp_diff_too_big;
...
assign selected_j_src = (reservation_time==7'b1111111) ? i_sj : v_j_src;
assign selected_k_src = (reservation_time==7'b1111111) ? i_sk : v_k_src;
...
// Result:
always@(posedge clk)
   o_result <= {result_sign4, (result_exp4[14:0] + ~{8'b0,lz_result4[5:0]} + 15'b1), (pre_norm_result4[47:0] << lz_result4[5:0])};


float_add_lz lz(.sj(pre_norm_result_carry[47:0]), .lz_final_result(lz_result[5:0]));
...
//      sk_exp1[14:0] <= shift_k1 ? (sk_exp0[14:0] + exp_sj_minus_sk0[14:0]) : sk_exp0[14:0];     //calculate new exponent, but just one number (ZS)

      sj_coef1[47:0] <= shift_j1 ? (sj_coef0[47:0] >> exp_sk_minus_sj0[5:0]) : sj_coef0[47:0];  //shift coefficient if necessary
      sk_coef1[47:0] <= shift_k1 ? (sk_coef0[47:0] >> exp_sj_minus_sk0[5:0]) : sk_coef0[47:0];  //shift coefficient if necessary
...
//stage 2 - figure out which has larger magnitude
      ...
      sk_coef2[47:0] <= sk_coef1[47:0];
      sj_sign2 <= sj_sign1;    //just copy over previous signs
      sk_sign2 <= sk_sign1;
	  add2 <= (instr1[6:0]==7'b0110010);	// ZS: instr2, not instr1


//stage 3 - add/subtract coefficients
      
      result_exp3 <= result_exp2;
      case({add2,(c_jgtk2 /*| c_jeqk2*/),sj_sign2, sk_sign2})            //sign=1 if neg
         4'b0000: begin	// pos-pos
                    pre_norm_result3[48:0] <= sk_coef2[47:0] + ~sj_coef2[47:0] + 48'b1;              
                    result_sign3 <= 1'b1;        //neg
                  end
         4'b0001: begin	// pos-neg
                    pre_norm_result3[48:0] <= sj_coef2[47:0] + sk_coef2[47:0];         
                    result_sign3 <= 1'b0;        //pos
                  end
         4'b0010: begin	// neg-pos
                    pre_norm_result3[48:0] <= sj_coef2[47:0] + sk_coef2[47:0];       
                    result_sign3 <= 1'b1;
                  end
         4'b0011: begin	// neg-neg
                    pre_norm_result3[48:0] <= sk_coef2[47:0] + ~sj_coef2[47:0] + 48'b1;       
                    result_sign3 <= 1'b0;
                  end
         4'b0100: begin	// pos-pos
                    pre_norm_result3[48:0] <= sj_coef2[47:0] + ~sk_coef2[47:0] + 48'b1;     
                    result_sign3 <= 1'b0;
                  end
         4'b0101: begin	// pos-neg
                    pre_norm_result3[48:0] <= sj_coef2[47:0] + sk_coef2[47:0];
                    result_sign3 <= 1'b0;
                  end
         4'b0110: begin	//neg-pos
                    pre_norm_result3[48:0] <= sj_coef2[47:0] + sk_coef2[47:0];        
                    result_sign3 <= 1'b1;
                  end
         4'b0111: begin	//neg-neg
                    pre_norm_result3[48:0] <= sj_coef2[47:0] + ~sk_coef2[47:0] + 48'b1;        
                    result_sign3 <= 1'b1;
                  end
         4'b1000: begin	// pos+pos
                    pre_norm_result3[48:0] <= sj_coef2[47:0] + sk_coef2[47:0];
                    result_sign3 <= 1'b0;
                  end
         4'b1001: begin	// pos+neg
                    pre_norm_result3[48:0] <= sk_coef2[47:0] + ~sj_coef2[47:0] + 48'b1;
                    result_sign3 <= 1'b1;
                  end
         4'b1010: begin	// neg+pos
                    pre_norm_result3[48:0] <= sk_coef2[47:0] + ~sj_coef2[47:0] + 48'b1;
                    result_sign3 <= 1'b0;
                  end
         4'b1011: begin	// neg+neg
                    pre_norm_result3[48:0] <= sj_coef2[47:0] + sk_coef2[47:0];
                    result_sign3 <= 1'b1;
                  end
         4'b1100: begin	// pos+pos
                    pre_norm_result3[48:0] <= sj_coef2[47:0] + sk_coef2[47:0];
                    result_sign3 <= 1'b0;
                  end
         4'b1101: begin	// pos+neg
                    pre_norm_result3[48:0] <= sj_coef2[47:0] + ~sk_coef2[47:0] + 48'b1;
                    result_sign3 <= 1'b0;
                  end
         4'b1110: begin	// neg+pos
                    pre_norm_result3[48:0] <= sj_coef2[47:0] + ~sk_coef2[47:0] + 48'b1;
                    result_sign3 <= 1'b1;
                  end
         4'b1111: begin	// neg+neg
                    pre_norm_result3[48:0] <= sj_coef2[47:0] + sk_coef2[47:0];
                    result_sign3 <= 1'b1;
                  end
      endcase      
...
//stage 4 - shift by 1 if carry-out==1, then leading zero count
        ...
        lz_result4[5:0] <= lz_result;
        result_sign4 <= result_sign3;
        result_exp4[14:0] <= (|pre_norm_result_carry) ? (pre_norm_result3[48] ? (result_exp3[14:0] + 15'b1) : result_exp3[14:0]) : 15'b0;
